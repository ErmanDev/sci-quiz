    ...
    >
      ...
      {isUnlocked ? (
        <div className="w-full flex flex-col items-center">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 opacity-0">
            &nbsp;
          </p>
        </div>
      ) : (
        <>
          <div className="w-full bg-gray-200 dark:bg-black/30 rounded-full h-2">
            <div
              className="h-2 rounded-full transition-all duration-500 bg-brand-glow shadow-[0_0_8px_rgba(167,153,255,0.7)]"
        ...
        >
          {activeFilter === 'CLASSROOM' ? (
            <div className="flex items-center justify-center h-48">
              <p className="text-2xl font-bold font-orbitron text-brand-glow">{t('comingSoon')}</p>
            </div>
          ) : (
            <>
