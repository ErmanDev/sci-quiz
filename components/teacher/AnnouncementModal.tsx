...
interface AnnouncementModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAnnounce: (message: string, date: string) => void;
}
    ...
    >
      ...
      >
        ...
        <input
          ...
          className="mt-4 w-full bg-brand-deep-purple/50 border-2 border-brand-light-purple/50 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-brand-glow transition-all duration-300"
        />
